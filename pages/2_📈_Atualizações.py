...
# --- controle do modal: estado sempre inicia fechado neste rerun ---
if 'atu_open_modal' not in st.session_state:
    st.session_state['atu_open_modal'] = False
# Ao entrar na página, garanta que esteja fechado; só clique na lupa reabre
st.session_state['atu_open_modal'] = False
...
with aba_incluir:
    ...
    # ===== Faixa superior em duas linhas (sem form) =====
    # Linha 1: labels
    ...
    # Linha 2: widgets (sem form_submit_button para o Enter não acionar a lupa)
    ...
    # Abre modal se flag estiver setada (somente clique na lupa seta a flag)
...
with aba_editar:
    ...
    id_edit = st.text_input("ID", key="atu_ed_id")
